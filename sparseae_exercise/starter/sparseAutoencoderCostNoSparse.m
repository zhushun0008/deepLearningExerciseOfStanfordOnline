function [cost,grad] = sparseAutoencoderCostNoSparse(theta, visibleSize, hiddenSize, ...
...
%	
% 	This is  a second version with regularization .
%	So just set beta equalling to zero and keep lambda
%	as a normal parameter.  
%	modify the first version to consider regularization.
